...
const TShirtsPage: React.FC = () => {
  ...
  // No longer needed - removed modal state variables
  ...
  const handleChooseOption = (optionId: string) => {
    // Navigate to the TShirtDetail page with the selected option id
    navigate(`/tshirt/${optionId}`);
  };
  ...
  return (
    ...
    >
      ...
      {/* Modal section removed - now navigating to dedicated detail page */}
    </motion.div>
  );
};
